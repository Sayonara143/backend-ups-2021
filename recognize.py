...
edged = cv2.Canny(blurred, 10, 120, 255)   
...
print(displayCnt)
lol = cv2.drawContours(edged,displayCnt,-1,(255, 0, 255),-1)
# output = cv2.bitwise_and(edged,edged,mask = mask)
# cv2.imshow("gray", lol)
cv2.imshow("output", edged)
cv2.imshow("pp", lol)
# cv2.imshow("contiur", output)
cv2.waitKey(0)